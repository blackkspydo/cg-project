...
// tombstones
const tombstoneGeometry = new THREE.BoxGeometry(0.6, 1.5, 0.2);
const tombstoneMaterial = new THREE.MeshStandardMaterial({ color: '#b2b6b1' });
...
const dirLightHelper = new THREE.DirectionalLightHelper(moonLight, 0.2);
...
const tick = () => {
    ...
    ghost1.position.x = Math.cos(ghost1Angle * .5) * 4;
    ...
    ghost2.position.y = Math.sin(elapsedTime) * Math.sin(elapsedTime * 2.5);
